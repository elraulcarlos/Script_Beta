    ...
    btn.MouseButton1Click:Connect(function()
        ...
        elseif name == "Visual" then
            ...
            toggleBtn.MouseButton1Click:Connect(function()
                ...
                toggleBtn.Text = espActivo and "Desactivar ESP" or "Activar ESP"
                toggleBtn.BackgroundColor3 = espActivo and Color3.fromRGB(255, 60, 60) or Color3.fromRGB(0, 200, 0)
            end)
